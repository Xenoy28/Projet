...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($email) || empty($password)) {
        ...
        if ($check->fetch()) {
            ...
            $stmt = $pdo->prepare('INSERT INTO utilisateur (nom, prenom, age, email, numero, mot_de_passe)
                                    VALUES (?, ?, ?, ?, ?, ?)');
            $stmt->execute([$nom, $prenom, $age ?: null, $email, $numero ?: null, $hash]);
...
<head>
    ...
    <title>SERENITY – Inscription</title>
...
<div style="width:100%;max-width:480px;">
    ...
    <div class="login-card">
        ...
        <div class="login-header">
            ...
            <h1>SERENITY</h1>
            <p>Là où tout s'apaise — Inscription</p>
        </div>
        ...
        <div class="login-body">
            ...
            <?php if ($success): ?>
                <div class="alert-dark-success mb-4 d-flex align-items-center gap-2">
                    ...
                    <a href="login.php" style="color:#93c5fd;font-weight:600;margin-left:6px;">Se connecter →</a>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" novalidate>
                ...
                <!-- Mot de passe -->
                <div class="mb-3">
                    <label class="form-label">Mot de passe <span style="color:#F87171">*</span></label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-lock"></i></span>
                        <input type="password" id="pwd" name="mot_de_passe" class="form-control"
                ...
                <!-- Confirmation -->
                <div class="mb-4">
                    <label class="form-label">Confirmer le mot de passe <span style="color:#F87171">*</span></label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-lock-fill"></i></span>
                        <input type="password" id="pwd2" name="mot_de_passe_confirm" class="form-control"
            ...
            <div class="text-center">
                <p style="color:#475569;font-size:.85rem;margin-bottom:6px;">Déjà un compte ?</p>
                <a href="login.php" style="color:var(--blue);font-weight:600;text-decoration:none;">
                    Se connecter →
                </a>
            </div>
        </div>
