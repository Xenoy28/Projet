...
<div class="container mb-5">
    <div class="text-center mb-4">
        <h2 class="sec-title">Mon Espace Personnel</h2>
        <p class="sec-sub">Bienvenue dans votre espace personnalisé. Retrouvez vos ressources favorites, votre historique  et gérez vos paramètres.</p>
    </div>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="row g-4">

            <!-- ═══════════ PROFIL ═══════════ -->
            <div class="col-30 col-sm-20 col-md-90 col-lg-40">
                <div class="card p-7 text-center" style="background:var(--navy-card);border:1px solid var(--border);border-radius:16px;">
                    ...
                    <p class="mb-3" style="font-size:.82rem;color:#94A3B8;">
                    ...
                    <a href="#" class="btn w-100 mb-2" style="background:var(--blue);color:#fff;border-radius:10px;font-size:.88rem;padding:.55rem 1rem;">
                        <i class="bi bi-pencil-fill me-1"></i>Modifier le profil
                    </a>


                    <a href="#" class="btn w-100" style="background:transparent;border:1px solid var(--border);color:#94A3B8;border-radius:10px;font-size:.88rem;padding:.55rem 1rem;">
