...
$discussions = [
    [
        ...
        "message"=>"Je me sens dépassée avec les examens qui arrivent.",
        "reponses"=>5,
        "likes"=>8
    ],
    [
        "auteur"=>"Lucas",
        "titre"=>"Cherche groupe de révision",
        "message"=>"Quelqu'un pour réviser les maths ensemble ?",
        "reponses"=>2,
        "likes"=>3
    ]
];
                ...
                <?php if ($user): ?>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="mon-espace.php">Mon espace</a></li>
                            <li><a class="dropdown-item" href="communaute.php">Communauté</a></li>
...
<section class="hero">
    ...
    <div class="container">
        ...
        <p>
            Discute avec d'autres étudiants, partage ton expérience et trouve du soutien.
        </p>
        ...
        <div class="col-lg-3">
            ...
            <div class="s-card p-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2">Forums</li>
                    <li class="mb-2">Mes groupes</li>
                    <li class="mb-2">Créer un groupe</li>
                    <li class="mb-2">Notifications</li>
                    <li>Membres</li>
            ...
            <div class="s-card p-3 mt-4">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2">Anxiété (120)</li>
                    <li class="mb-2">Étudiants L1 (85)</li>
                    <li>Handicap invisible (50)</li>
