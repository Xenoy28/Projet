...
if (isset($_GET['deconnecte'])) {
    $success = 'Vous avez été déconnecté(e) avec succès.';
}
...
<head>
    ...
    <title>SERENITY – Connexion</title>
...
<div style="width:100%;max-width:440px;">
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            <h1>SERENITY</h1>
            <p>Là où tout s'apaise — Connexion</p>
        </div>
            ...
            <form method="POST" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="pwd" name="mot_de_passe" class="form-control" placeholder="••••••••" required>
